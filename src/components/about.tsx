      ...
      <div className="h-100% max-w-screen-xl pt-[12%] mx-auto">
        <div className="flex flex-col items-center ">
          <motion.span
            ...
            className="pt-0 pl-9 pr-9 pb-5 lg:ml-52 lg:mr-52 text-justify mx-auto text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-2xl justify-center-safe text-zinc-400 "
          >
            <p className="pb-3 text-justify">
              I’m a Geodetic & Geomatics Engineer, specialist Geoinformatics.
              Now, I focusing on passion{" "}
              <span className="text-justify  hover:underline">
