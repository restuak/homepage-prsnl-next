...
export default function Welcome() {
  return (
    <>
      <div className="bg-black h-screen flex flex-col justify-center max-w-screen-xl px-6 md:px-10 mx-auto">
        <div>
          <div className="font-bold ">
            <h1>
              <span className="text-4xl sm:text-6xl md:text-6xl lg:text-7xl xl:text-7xl text-white animate-fade animate-once animate-delay-100">
                Hi, I&apos;m Restu
              </span>
        ...
        <div className="absolute bottom-0 left-0 w-full flex justify-center pb-10 overflow-y-hidden">
          <div className="animate-fade-up animate-once animate-delay-2000 animate-ease-out z-20 flex flex-col items-center cursor-pointer">
            <span className="animate-bounce text-4xl text-bold text-white">
              <RiArrowDownWideFill />
            </span>
          </div>
        </div>
