...
//                 <span className="animate-hand-wave inline-block origin-[70%_70%] [animation-delay:2700ms]">
//                   👋
//                 </span>{" "}
//                 Hi, I&apos;m
//               </span>{" "}
...
//                 <span
//                   className="text-cyan-400 opacity-30 animate-dimmed delay-500"
//                   onClick={() =>
//                     lenis &&
...
//               <span className="opacity-30 animate-dimmed [animation-delay:1700ms]">
//                 A
//               </span>{" "}
//               <LinkPreview
//                 url="#technologies"
...
//               >
//                 <span
//                   className="text-cyan-400 opacity-30 animate-dimmed [animation-delay:800ms]"
//                   onClick={() =>
//                     lenis &&
...
//                 </span>
//               </LinkPreview>{" "}
//               <span className="opacity-30 animate-dimmed [animation-delay:2000ms]">
//                 who craft
//               </span>{" "}
//               <br className="hidden sm:block" />
//               <LinkPreview
//                 url="#projects"
//                 imageSrc="images/projects.jpeg"
//                 isStatic
//               >
//                 <span
//                   className="text-cyan-400 opacity-30 animate-dimmed [animation-delay:1100ms]"
//                   onClick={() =>
//                     lenis &&
